...
# here, if "R = 0" then the denominator is nonzero  (it's "1")
# and the numerator is zero. there's no problem when evaluating at zero.

# there's a problem if we divide by this function and then evaluate at zero.
# there's a problem if we define "f32R = f3(R) / f2(R)".
