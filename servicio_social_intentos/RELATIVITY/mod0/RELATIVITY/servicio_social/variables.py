...
data_cond = pd.read_csv(r'init_cond.dat', sep=',')

data_gas = pd.read_csv(r'init_gas.dat', sep=',')
...
# by using some condition on the first derivative?
...
# the initial conditions will be stored in
