...
start = 0.2  # this is where we start searching for values of "R0" (the left/lower bound of the interval we're searching in)
R0_increment = 1  # the increment to the next value of "R0" in the interval we're searching in
quantity = 5  # amount of points ("R0" values) in the list we'd be searching
