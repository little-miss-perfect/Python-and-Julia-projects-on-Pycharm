...
# we need to have modified the "LSODA" method by now to check for a divergence given an initial value of "R0".

# this next class is for setting prefixed values of the parameters we want in our code
...
# TODO 9: create a function/class that checks the initial value of "R0"
