...
r_guess[0, :] = scene.r0[0]  # for "n0"
r_guess[1, :] = scene.r0[1]  # for "m0"
r_guess[2, :] = scene.r0[2]  # for "R0"  # guess for R(u), e.g. some constant
r_guess[3, :] = scene.r0[3]  # for "DR0"  # guess for R1(u)
r_guess[4, :] = scene.r0[4]  # for "P0"
r_guess[5, :] = scene.r0[5]  # for "Ms0"
r_guess[6, :] = scene.r0[6]  # for "Mb0"
...
# TODO: solve the BIG PROBLEM... this works for "solve_ivp", that evaluates the functions at each point, but not for "solve_bvp",
#  that evaluates the functions at arrays. so we'll need to fix this.
